...
export const AppletInfo = {
    ...
    'Blob': { folderUrl:'./General/threejs/blob',       devices:['eeg'],           categories:['feedback']},
    'Enso': { folderUrl:'./General/threejs/enso',       devices:['eeg'],           categories:['feedback']},
    'Cosmos': { folderUrl:'./General/threejs/cosmos',   devices:['eeg'],           categories:['feedback']},
