...
import {brainsatplay} from './js/brainsatplay.js'
...
let ui = new DOMFragment(
	...
	() => {
		...
		document.getElementById('connect').onclick = () => {
			...
			if(bcisession.info.auth.authenticated) bcisession.connect('muse',['eegcoherence'],onconnected,undefined,true,[['eegch','AF7','all'],['eegch','AF8','all']]);
