...
export const py_client = null

if(cfg.settings.python){
    py_client = new WebSocket(
        python_socketUrl,
        {
...
export const py_socketUrl = `ws://${cfg.settings.host}:${cfg.settings.python_node}`;

export const py_wss = null;

if(cfg.settings.python){
    py_wss = new WebSocketServer({ // new WebSocket.Server({
