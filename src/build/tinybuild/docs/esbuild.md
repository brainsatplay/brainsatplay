...
As long as your entry point is a typescript file, this esbuild plugin can generate .d.ts type files for all of your script files. These function sort of like header files in C, which show you all of the functions/classes/variables/etc. in each respective script file.
