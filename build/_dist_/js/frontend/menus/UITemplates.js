import t from"../../../assets/menu.svg.proxy.js";import n from"../../../assets/menuX.svg.proxy.js";import o from"../../../assets/logo512.png.proxy.js";import d from"../../../assets/file_noun.svg.proxy.js";import i from"../../../assets/csv_noun.svg.proxy.js";export function page_template(e={}){return`
    <div id="page">
    </div>`}export function topbar_template(e={}){return`
    <div id="topbar">
    </div>`}export function menu_template(e={}){return`
    <img id="logo" src=`+o+` style="position:absolute; height:50px; left:50%; margin-left:-25px; width:50px; top:17px; z-index:9999; pointer-events:none;"/>  
    ...
    </table>`}export function menuheader_template(e={}){return`
    ...
    <td id="files" style="width:7.5%;">
        <img id="filesvg" src=`+d+` style="height:60px;width:60px; transform:translateY(6px);" />
    </td>
    <td id="menu" style="width:75%;"> 
        <div style="float:right; margin-right: 80px;">
            <img id="menusvg" src=`+t+` style="position:absolute; height:60px;width:60px; top:12.5px;"/>   
            <img id="menuxsvg" src=`+n+` style="position:absolute; height:60px;width:60px; top:12.5px; display:none; opacity:0;"/>
            <input style="display:none;" type="checkbox" id="menucheckbox" title="Menu">
        </div>
    </td>
    `}export function menudropdown_template(e={}){return`
    <td style="width:100%; vertical-align:center; border:2px inset black;" colspan=6>
     ...
     </td>`}export function appletselect_template(e={}){return`
    <div>
    ...
    `}export function login_template(e={}){return`
...
`}export function appletbox_template(e={containerId:"applets",styleInlineText:"flex-grow: 1;"}){return`
    <div style='`+e.styleInlineText+"z-index:2; display:flex;' id='"+e.containerId+`'></div>
    `}export function filemenu_template(e={}){return`
    ...
    `}export function file_template(e={id:Math.random()}){return`
    <div id="`+e.id+`">
        <p id="`+e.id+'filename">'+e.id+'</p><button id="'+e.id+`delete">X</button>
        <img id="`+e.id+'svg" src="'+i+`" style="height:60px;width:60px;">
    </div>
    `}export function menu_setup(){document.getElementById("menuxsvg").style.display="none",document.getElementById("menusvg").addEventListener("click",()=>{document.getElementById("menucheckbox").click(),document.getElementById("menusvg").style.opacity=0,document.getElementById("menuxsvg").style.display="",setTimeout(()=>{document.getElementById("menuxsvg").style.opacity=1,document.getElementById("menusvg").style.display="none"},300)}),document.getElementById("menuxsvg").addEventListener("click",()=>{document.getElementById("menucheckbox").click(),document.getElementById("menusvg").style.display="",document.getElementById("menuxsvg").style.opacity=0,setTimeout(()=>{document.getElementById("menusvg").style.opacity=1,document.getElementById("menuxsvg").style.display="none"},300)}),document.getElementById("filesvg").onclick=()=>{document.getElementById("menucheckbox").checked===!0&&document.getElementById("menuxsvg").click(),document.getElementById("menu_dropdown3").style.opacity==="0"?(document.getElementById("menu_dropdown2").style.opacity=0,document.getElementById("menu_dropdown2").style.transform="translateY(-900px)",document.getElementById("menu_dropdown2").style.transition="transform 0.5s ease-in-out, opacity 0.1s ease",document.getElementById("menu_dropdown").style.opacity=0,document.getElementById("menu_dropdown").style.transform="translateY(-500px)",document.getElementById("menu_dropdown").style.transition="transform 0.5s ease-in-out, opacity 0.1s ease",document.getElementById("menu_dropdown3").style.transform="translateY(-700px)",document.getElementById("menu_dropdown3").style.opacity=1,document.getElementById("menu_dropdown3").style.transition="transform 0.5s ease-in-out, opacity 0.4s ease 0.3s",document.getElementById("UI").style.zIndex=999):(document.getElementById("menu_dropdown3").style.transform="translateY(-1300px)",document.getElementById("menu_dropdown3").style.opacity=0,document.getElementById("menu_dropdown3").style.transition="transform 0.5s ease-in-out, opacity 0.1s ease",document.getElementById("UI").style.zIndex=-1)},document.getElementById("menucheckbox").addEventListener("click",()=>{document.getElementById("menucheckbox").checked===!0?(document.getElementById("menu_dropdown2").style.opacity=0,document.getElementById("menu_dropdown2").style.transform="translateY(-900px)",document.getElementById("menu_dropdown2").style.transition="transform 0.5s ease-in-out, opacity 0.1s ease",document.getElementById("menu_dropdown3").style.transform="translateY(-1300px)",document.getElementById("menu_dropdown3").style.opacity=0,document.getElementById("menu_dropdown2").style.transition="transform 0.5s ease-in-out, opacity 0.1s ease",document.getElementById("menu_dropdown").style.opacity=1,document.getElementById("menu_dropdown").style.transform="translateY(0px)",document.getElementById("menu_dropdown").style.transition="transform 0.5s ease-in-out, opacity 0.4s ease 0.3s",document.getElementById("UI").style.zIndex=999):(document.getElementById("menu_dropdown").style.opacity=0,document.getElementById("menu_dropdown").style.transform="translateY(-500px)",document.getElementById("menu_dropdown").style.transition="transform 0.5s ease-in-out, opacity 0.1s ease",document.getElementById("UI").style.zIndex=-1)}),document.getElementById("visualsbutton").addEventListener("click",()=>{document.getElementById("menucheckbox").checked===!0&&document.getElementById("menuxsvg").click(),document.getElementById("menu_dropdown2").style.opacity==="0"?(document.getElementById("menu_dropdown2").style.opacity=1,document.getElementById("menu_dropdown2").style.transform="translateY(-300px)",document.getElementById("menu_dropdown2").style.transition="transform 0.5s ease-in-out, opacity 0.4s ease 0.3s",document.getElementById("menu_dropdown3").style.transform="translateY(-1300px)",document.getElementById("menu_dropdown3").style.opacity=0,document.getElementById("menu_dropdown2").style.transition="transform 0.5s ease-in-out, opacity 0.1s ease",document.getElementById("menu_dropdown").style.opacity=0,document.getElementById("menu_dropdown").style.transform="translateY(-500px)",document.getElementById("menu_dropdown").style.transition="transform 0.5s ease-in-out, opacity 0.1s ease",document.getElementById("UI").style.zIndex=999):(document.getElementById("menu_dropdown2").style.opacity=0,document.getElementById("menu_dropdown2").style.transform="translateY(-900px)",document.getElementById("menu_dropdown2").style.transition="transform 0.5s ease-in-out, opacity 0.1s ease",document.getElementById("UI").style.zIndex=-1)})}
