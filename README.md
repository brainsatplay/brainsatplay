...
- [**tinybuild**](https://github.com/brainsatplay/brainsatplay/build) combines ultra fast and lightweight esbuild, hot reloading node and python (optional), and quick config/setup via boilerplate.
