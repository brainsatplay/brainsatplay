...
| **[wasl]**         | [![wasl-status]][graphscript] | The web application specification language used by the [brainsatplay] library       |
...
#### [Introduction](./docs/docs/README.md)
A comprehensive introduction to the Brains@Play ecosystem.

#### [Education](./docs/docs/education/README.md)
...
A collection of tutorials on how to use the core libraries of the Brains@Play ecosystem.

### Source Code (src)
#### core
A linker library between [graphscript], [wasl], and [visualscript].
